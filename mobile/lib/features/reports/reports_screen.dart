              ...
              SectionCard(
                child: Column(
                  children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(context.l10n.collectionRate,
                    ...
                    const SizedBox(height: 16),
                    _amountRow(context.l10n.expected, report.expected),
                    _amountRow(context.l10n.collected, report.collected, color: AppColors.paid),
                    _amountRow(context.l10n.outstanding, report.outstanding, color: AppColors.unpaid),
                  ],
                ),
              ),
              const SizedBox(height: 16),
